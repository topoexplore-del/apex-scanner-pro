"""
APEX SCANNER PRO — Build Data Pipeline v7.0
...
def run_backtest_for_ticker(ticker, hist, ind, fund_data, is_etf=False):
    ...
    # Results structure
    entry_trades = {p["key"]: [] for p in HOLD_PERIODS}  # Entry Zone trades
...
def main():
    ...
    print(f"APEX SCANNER PRO — Building data at {datetime.now()}")
    groups_data = {}
